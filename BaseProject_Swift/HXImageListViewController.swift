...
class HXImageListViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        let collectionView = UICollectionView(frame: CGRect(x: 0, y: 0, width: hxip_screenWidth, height: hxip_screenHeight - toolBarHeight - temp), collectionViewLayout: layout)
    ...
    private lazy var imageToolView: HXImageToolView = {
        ...
        let imageToolView = HXImageToolView(frame: CGRect(x: 0, y: hxip_screenHeight - toolBarHeight - temp, width: hxip_screenWidth, height: toolBarHeight), type: .list)
